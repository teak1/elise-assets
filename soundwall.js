...
function soundwall(o, mount) {
  ...
  <style>
  .soundwall-container {position: relative;width: 500px;background-color:rgba(200,200,200,0.6);}
  ...
  .soundwall-container:hover .soundwall-text {opacity: 1;}
  ...
  <div class="soundwall-middle">
    <a>
    <div class="soundwall-text"><b>Click to open soundwall</b></div>
    </a>
  </div>
  `}
  </div>
  ...
  <div class="soundwall-display-wrapper" hidden>
    ...
    <div id="${wrapperId}">
    <img class="${isMobile ? "soundwall-overlay-image-horizontal" : "soundwall-overlay-image-vertical"}" id="${imgId}"/>
    </div>
  </div>
  </div>
